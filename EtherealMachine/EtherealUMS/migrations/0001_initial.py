# Generated by Django 5.1.2 on 2024-10-08 17:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='axes', to='EtherealUMS.machine')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'Super Admin'), ('manager', 'Manager'), ('supervisor', 'Supervisor'), ('operator', 'Operator')], max_length=20)),
